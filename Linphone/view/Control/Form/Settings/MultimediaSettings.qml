...
ColumnLayout {
	...
	RoundedPane {
		...
		topPadding: background.visible ? 25 * mainWindow.dp : 0
		bottomPadding: background.visible ? 25 * mainWindow.dp : 0
		leftPadding: background.visible ? 25 * mainWindow.dp : 0
		rightPadding: background.visible ? 25 * mainWindow.dp : 0
			...
			ColumnLayout {
				...
				RowLayout {
					...
					EffectImage {
						...
						imageWidth: 24 * mainWindow.dp
						imageHeight: 24 * mainWindow.dp
					}
					Text {
				...
				ComboSetting {
					Layout.fillWidth: true
					Layout.topMargin: 12 * mainWindow.dp
