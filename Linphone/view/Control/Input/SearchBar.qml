...
FocusScope {
	...
	property int textInputWidth: 350 * mainWindow.dp
	...
	implicitHeight: 50 * mainWindow.dp
	
	Rectangle{
		id: backgroundItem
		anchors.fill: parent
		radius: 28 * mainWindow.dp
	...
	Control.TextField {
		...
		anchors.leftMargin: magnifier.visible ? 0 : 10 * mainWindow.dp
