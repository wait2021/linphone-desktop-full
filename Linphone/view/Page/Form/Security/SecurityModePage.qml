		...
		RowLayout {
			...
			Repeater {
				model: [
					...
					{
						checked: true,
						title: qsTr("manage_account_e2e_encrypted_mode_default_title"),
						...
						text: qsTr("manage_account_e2e_encrypted_mode_default_summary"),
						imgUrl: AppIcons.chiffrement,
						color: DefaultStyle.info_500_main
					},
					//: "Interoperable"
					{
						checked: false,
						title: qsTr("manage_account_e2e_encrypted_mode_interoperable_title"),
						...
						text: qsTr("manage_account_e2e_encrypted_mode_interoperable_summary"),
						imgUrl: AppIcons.interoperable,
				...
				SecurityRadioButton {
					...
					onCheckedChanged: {
						if (checked)
							continueButton.selectedIndex = index;
					}
				}
			}
		}
