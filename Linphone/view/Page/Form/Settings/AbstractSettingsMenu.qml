...
AbstractMainPage {
	...
	leftPanelContent: ColumnLayout {
		...
		ListView {
			...
			delegate: SettingsMenuItem {
				...
				onSelected: {
					...
					rightPanelStackView.push(layoutUrl(modelData.layout), {
												 titleText: modelData.title,
		...
		Component.onCompleted: {
			...
			rightPanelStackView.push(layoutUrl(initialEntry.layout), {
										 titleText: initialEntry.title,
										 model: initialEntry.model,
										 container: rightPanelStackView
									 });
