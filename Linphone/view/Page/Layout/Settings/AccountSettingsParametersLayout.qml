...
AbstractSettingsLayout {
	...
	Connections {
		...
		function onSetValueFailed(error) {
			if (error) {
				UtilsCpp.showInformationPopup(qsTr("information_popup_error_title"), error, false, mainWindow);
			}
		}
	}
			...
			DecoratedTextField {
				...
				Connections {
					...
					function onConferenceFactoryAddressChanged() {
						if (conferenceFactoryUriField.text
								!= conferenceFactoryUriField.propertyOwnerGui.core[conferenceFactoryUriField.propertyName])
							conferenceFactoryUriField.text
									= conferenceFactoryUriField.propertyOwnerGui.core[conferenceFactoryUriField.propertyName];
					}
				}
			}
			DecoratedTextField {
				...
				Connections {
					...
					function onAudioVideoConferenceFactoryAddressChanged() {
						if (audioVideoConfUriField.text
								!= audioVideoConfUriField.propertyOwnerGui.core[audioVideoConfUriField.propertyName])
