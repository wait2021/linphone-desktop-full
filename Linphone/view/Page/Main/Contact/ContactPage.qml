...
AbstractMainPage {
	...
	*/
	...
	property bool leftPanelEnabled: !rightPanelStackView.currentItem || rightPanelStackView.currentItem.objectName
									!= "contactEdition"
		...
		ColumnLayout {
			...
			ColumnLayout {
				...
				AllContactListView {
					...
					sourceFlags: LinphoneEnums.MagicSearchSource.Friends | LinphoneEnums.MagicSearchSource.FavoriteFriends
								 | LinphoneEnums.MagicSearchSource.LdapServers | LinphoneEnums.MagicSearchSource.RemoteCardDAV
	...
	Component {
		...
		Item {
			...
			ContactLayout {
				...
				button.visible: mainItem.selectedContact && mainItem.selectedContact.core.isStored &&
								!mainItem.selectedContact.core.readOnly
					...
					ColumnLayout {
						...
						ColumnLayout {
							...
							ContactDetailLayout {
								...
								content: ListView {
									...
									model: VariantList {
										model: (mainItem.selectedContact ? UtilsCpp.append(mainItem.selectedContact.core.addresses,
																						   mainItem.selectedContact.core.phoneNumbers) : [])
									}
									delegate: Item {
						...
						ContactDetailLayout {
							...
							content: ColumnLayout {
								...
								ListView {
									id: deviceList
									Layout.fillWidth: true
									Layout.preferredHeight: Math.min(Utils.getSizeWithScreenRatio(200), contentHeight)
									clip: true
									...
									delegate: RowLayout {
										...
										//: "Appareil inconnu"
										property string deviceName: listViewModelData.name.length != 0 ? listViewModelData.name : qsTr(
						...
						ContactDetailLayout {
							...
							content: ColumnLayout {
								...
								ColumnLayout {
									visible: mainItem.selectedContact && mainItem.selectedContact.core.isStored &&
											 !mainItem.selectedContact.core.readOnly
									IconLabelButton {
										Layout.fillWidth: true
								...
								ColumnLayout {
									...
									IconLabelButton {
										Layout.fillWidth: true
										Layout.preferredHeight: Utils.getSizeWithScreenRatio(50)
										icon.source: mainItem.selectedContact && mainItem.selectedContact.core.starred ? AppIcons.heartFill :
																														 AppIcons.heart
										text: mainItem.selectedContact && mainItem.selectedContact.core.starred ?
												  //: "Retirer des favoris"
										...
										onClicked: if (mainItem.selectedContact)
													   mainItem.selectedContact.core.lSetStarred(!mainItem.selectedContact.core.starred)
									}
									Rectangle {
										Layout.fillWidth: true
										Layout.preferredHeight: Utils.getSizeWithScreenRatio(1)
										...
										if (mainItem.selectedContact) {
											...
											if (filepath == "")
												UtilsCpp.showInformationPopup(qsTr("information_popup_error_title"),
																			  ...
																			  qsTr("contact_details_share_error_mesage"), false);
											else
											...
											UtilsCpp.shareByEmail(
														//: "Partage de contact"
														qsTr("contact_details_share_email_title"), vcard, filepath);
										}
									}
								}
								// IconLabelButton {
