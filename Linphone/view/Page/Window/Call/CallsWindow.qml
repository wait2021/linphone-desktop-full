...
AbstractWindow {
	...
	property bool startingCall: mainWindow.callState == LinphoneEnums.CallState.OutgoingInit || mainWindow.callState
								== LinphoneEnums.CallState.OutgoingProgress || mainWindow.callState == LinphoneEnums.CallState.OutgoingRinging
								|| mainWindow.callState == LinphoneEnums.CallState.OutgoingEarlyMedia || mainWindow.callState
								== LinphoneEnums.CallState.IncomingReceived
	property Item firstButtonInBottomTab: mainWindow.startingCall ? endCallButton : (videoCameraButton.visible
																					 && videoCameraButton.enabled ? videoCameraButton : audioMicrophoneButton)
	property Item lastButtonInBottomTab: mainWindow.startingCall ? Utils.getLastFocusableItemInItem(controlCallButtons) :
																   endCallButton
	...
	onCallStateChanged: {
		if (callState === LinphoneEnums.CallState.Connected) {
			...
			if (call.core.encryption === LinphoneEnums.MediaEncryption.Zrtp && !mainWindow.isConference && (
						!call.core.tokenVerified || call.core.isMismatch)) {
				zrtpValidation.open();
			}
	...
	onTransferStateChanged: {
		...
		if (mainWindow.transferState === LinphoneEnums.CallState.OutgoingInit) {
		...
		} else if (mainWindow.transferState === LinphoneEnums.CallState.Error || mainWindow.transferState
				   === LinphoneEnums.CallState.End || mainWindow.transferState === LinphoneEnums.CallState.Released
			...
			if (transferState === LinphoneEnums.CallState.Error)
				UtilsCpp.showInformationPopup(qsTr("information_popup_error_title"),
											  ...
											  qsTr("call_transfer_failed_toast"), false, mainWindow);
	...
	component BottomButton: Button {
		...
		background: Rectangle {
			anchors.fill: parent
			color: bottomButton.enabled ? disabledIcon ? DefaultStyle.grey_500 : bottomButton.pressed || bottomButton.checked
		...
		ColumnLayout {
			...
			Item {
				...
				RowLayout {
					...
					RowLayout {
						...
						Loader {
							...
							sourceComponent: EffectImage {
								...
								imageSource: !mainWindow.call ? AppIcons.meeting : (mainWindow.callState === LinphoneEnums.CallState.End
																					|| mainWindow.callState === LinphoneEnums.CallState.Released) ? AppIcons.endCall : (
																																						mainWindow.call.core.paused || mainWindow.callState
																																						=== LinphoneEnums.CallState.Paused || mainWindow.callState
																																						=== LinphoneEnums.CallState.PausedByRemote) ? AppIcons.pause :
																																																	  mainWindow.conference ? AppIcons.videoconference :
																																																							  mainWindow.call.core.dir === LinphoneEnums.CallDir.Outgoing
																																																							  ? AppIcons.arrowUpRight : AppIcons.arrowDownLeft
								colorizationColor: !mainWindow.call || mainWindow.call.core.paused || mainWindow.callState
												   === LinphoneEnums.CallState.Paused || mainWindow.callState === LinphoneEnums.CallState.PausedByRemote
												   || mainWindow.callState === LinphoneEnums.CallState.End || mainWindow.callState
												   === LinphoneEnums.CallState.Released || mainWindow.conference ? DefaultStyle.danger_500_main :
																												   mainWindow.call.core.dir === LinphoneEnums.CallDir.Outgoing ? DefaultStyle.info_500_main :
						...
						ColumnLayout {
							...
							RowLayout {
								...
								Text {
									id: callStatusText
									property string remoteName: mainWindow.call ? qsTr("call_dir").arg(EnumsToStringCpp.dirToString(
																										   mainWindow.call.core.dir)) : ""
									Connections {
										target: mainWindow
										onCallStateChanged: {
											if (mainWindow.callState === LinphoneEnums.CallState.Connected || mainWindow.callState
													=== LinphoneEnums.CallState.StreamsRunning)
												callStatusText.remoteName = mainWindow.call.core.remoteName;
										}
									}

									text: (mainWindow.callState === LinphoneEnums.CallState.End || mainWindow.callState
										   === LinphoneEnums.CallState.Released) ?
											  //: Appel terminé
											  qsTr("call_ended") : mainWindow.call && (mainWindow.call.core.paused) ? (mainWindow.conference ?
																														   //: Meeting paused
																														   qsTr("conference_paused") : mainWindow.callState
																														   === LinphoneEnums.CallState.PausedByRemote ?
																															   //: Call paused by remote
																															   qsTr("call_paused_by_remote") :
																															   //: Call paused
																															   qsTr("call_paused")) : mainWindow.conference ? mainWindow.conference.core.subject :
																																											  remoteName
									color: DefaultStyle.grey_0
									font {
								...
								Rectangle {
									visible: mainWindow.call && (mainWindow.callState === LinphoneEnums.CallState.Connected || mainWindow.callState
																 === LinphoneEnums.CallState.StreamsRunning)
								...
								Text {
									...
									visible: mainWindow.callState === LinphoneEnums.CallState.Connected || mainWindow.callState
											 === LinphoneEnums.CallState.StreamsRunning
								}
								Text {
									id: conferenceDate
							...
							RowLayout {
								...
								Connections {
									...
									function onCallStateChanged() {
										...
										else if (mainWindow.callState === LinphoneEnums.CallState.End || mainWindow.callState
												 === LinphoneEnums.CallState.Released)
								...
								EffectImage {
									Layout.preferredWidth: Utils.getSizeWithScreenRatio(15)
									Layout.preferredHeight: Utils.getSizeWithScreenRatio(15)
									colorizationColor: mainWindow.conference ? DefaultStyle.info_500_main : mainWindow.call ? mainWindow.call.core.encryption
																															  === LinphoneEnums.MediaEncryption.Srtp ? DefaultStyle.info_500_main :
																																									   ...
																																									   ? mainWindow.call.core.isMismatch || !mainWindow.call.core.tokenVerified
																																										 ? DefaultStyle.warning_600 : DefaultStyle.info_500_main :
																																										   DefaultStyle.grey_0 : "transparent"
									visible: mainWindow.call
									imageSource: mainWindow.conference ? AppIcons.lockKey : mainWindow.call ? mainWindow.call.core.encryption
																											  === LinphoneEnums.MediaEncryption.Srtp ? AppIcons.lockSimple : mainWindow.call
																																					   && mainWindow.call.core.encryption === LinphoneEnums.MediaEncryption.Zrtp
																																					   ? mainWindow.call.core.isMismatch || !mainWindow.call.core.tokenVerified
																																						 ? AppIcons.warningCircle : AppIcons.lockKey : AppIcons.lockSimpleOpen : ""
								}
								Text {
									id: encryptionStatusText
									text: mainWindow.conference ? mainWindow.call.core.conferenceSecurityLevel
																  === LinphoneEnums.ConferenceSecurityLevel.EndToEnd ?
																	  //: End to end encrypted meeting
																	  qsTr("conference_end_to_end_encrypted") :
																	  //: Point to point encrypted meeting
																	  qsTr("conference_srtp_point_to_point_encrypted") : mainWindow.call ? mainWindow.call.core.encryption
																																		   === LinphoneEnums.MediaEncryption.Srtp ?
																																			   //: Appel chiffré de point à point
																																			   qsTr("call_srtp_point_to_point_encrypted") : mainWindow.call.core.encryption
																																			   === LinphoneEnums.MediaEncryption.Zrtp ? mainWindow.call.core.isMismatch ||
																																														!mainWindow.call.core.tokenVerified ?
																																															//: Vérification nécessaire
																																															qsTr("call_zrtp_sas_validation_required") :
																																															//: Appel chiffré de bout en bout
																																															qsTr("call_zrtp_end_to_end_encrypted") : mainWindow.call.core.encryption
																																															=== LinphoneEnums.MediaEncryption.None ?
																																																//: "Appel non chiffré"
																																																qsTr("call_not_encrypted") : qsTr("call_waiting_for_encryption_info") :
																																																""
									color: mainWindow.conference || mainWindow.call?.core.encryption === LinphoneEnums.MediaEncryption.Srtp
										   ? DefaultStyle.info_500_main : mainWindow.call ? mainWindow.call.core.encryption
																							=== LinphoneEnums.MediaEncryption.Zrtp ? mainWindow.call.core.isMismatch ||
																																	 !mainWindow.call.core.tokenVerified ? DefaultStyle.warning_600 :
																																										   DefaultStyle.info_500_main : DefaultStyle.grey_0 : DefaultStyle.grey_0
									font {
									...
									MouseArea {
										...
										onClicked: {
											if (rightPanel.visible && rightPanel.contentLoader.item.objectName === "encryptionPanel")
					...
					Button {
						...
						icon.source: quality >= 4 ? AppIcons.cellSignalFull : quality >= 3 ? AppIcons.cellSignalMedium : quality >= 2
																							 ? AppIcons.cellSignalLow : AppIcons.cellSignalNone
						...
						onClicked: {
							if (rightPanel.visible && rightPanel.contentLoader.item.objectName === "statsPanel")
								rightPanel.visible = false;
							else {
								rightPanel.visible = true;
				...
				Control.Control {
					...
					visible: mainWindow.call ? !!mainWindow.conference ? mainWindow.conference.core.isRecording
																		 || isScreenSharing//mainWindow.conference.core.isLocalScreenSharing
																	   : (mainWindow.call.core.recording || mainWindow.call.core.remoteRecording) : false
					anchors.centerIn: parent
					...
					contentItem: RowLayout {
						...
						RowLayout {
							...
							EffectImage {
								imageSource: screenSharingOrRecordBanner.isScreenSharing ? AppIcons.screencast : AppIcons.recordFill
								colorizationColor: screenSharingOrRecordBanner.isScreenSharing ? DefaultStyle.grey_0 :
																								 DefaultStyle.danger_500_main
								Layout.preferredWidth: Utils.getSizeWithScreenRatio(24)
								Layout.preferredHeight: Utils.getSizeWithScreenRatio(24)
							}
							Text {
								color: screenSharingOrRecordBanner.isScreenSharing ? DefaultStyle.grey_0 : DefaultStyle.danger_500_main
								font: Typography.b1
								text: mainWindow.call ? screenSharingOrRecordBanner.isScreenSharing ?
															//: "You are sharing your screen"
															qsTr("conference_user_is_sharing_screen") : mainWindow.call.core.recording ? mainWindow.conference ?
																																			 //: "You are recording the meeting"
																																			 qsTr("conference_user_is_recording") :
																																			 //: "You are recording the call"
																																			 qsTr("call_user_is_recording") : mainWindow.conference ?
						...
						MediumButton {
							visible: mainWindow.call && mainWindow.call.core.recording || screenSharingOrRecordBanner.isScreenSharing
							...
							onPressed: {
								if (screenSharingOrRecordBanner.isScreenSharing)
									mainWindow.conference.core.lToggleScreenSharing();
								else
			...
			RowLayout {
				...
				CallSettingsPanel {
					...
					KeyNavigation.tab: Utils.isDescendant(nextItemInFocusChain(), rightPanel) ? nextItemInFocusChain() :
																								videoCameraButton
					...
					Connections {
						...
						function onItemChanged() {
							...
							if (!rightPanel.contentLoader.item || rightPanel.contentLoader.item.objectName !== "participantListPanel")
								rightPanel.headerStack.currentIndex = 0;
							if (!rightPanel.contentLoader.item || rightPanel.contentLoader.item.objectName !== "callTransferPanel")
								transferCallButton.checked = false;
							if (!rightPanel.contentLoader.item || rightPanel.contentLoader.item.objectName !== "newCallPanel")
								newCallButton.checked = false;
							if (!rightPanel.contentLoader.item || rightPanel.contentLoader.item.objectName !== "callListPanel")
								callListButton.checked = false;
							if (!rightPanel.contentLoader.item || rightPanel.contentLoader.item.objectName !== "screencastPanel")
								screencastPanelButton.checked = false;
							if (!rightPanel.contentLoader.item || rightPanel.contentLoader.item.objectName !== "chatPanel")
								chatPanelButton.checked = false;
							if (!rightPanel.contentLoader.item || rightPanel.contentLoader.item.objectName !== "participantListPanel")
					...
					NewCallForm {
						...
						onContactClicked: contact => {
											  ...
											  callsWin.showConfirmationLambdaPopup(qsTr("call_transfer_confirm_dialog_tittle"),
																				   ...
																				   qsTr("call_transfer_confirm_dialog_message").arg(mainWindow.call.core.remoteName).arg(
						...
						onTransferCallToAnotherRequested: dest => {
															  ...
															  callsWin.showConfirmationLambdaPopup(qsTr("call_transfer_confirm_dialog_tittle"), qsTr(
																									   "call_transfer_confirm_dialog_message").arg(mainWindow.call.core.remoteName).arg(
																									   dest.core.remoteName), "", function (confirmed) {
																										   if (confirmed) {
				...
				Control.Control {
					...
					contentItem: ScreencastSettings {
						...
						onIsLocalScreenSharingChanged: {
							...
							if (isLocalScreenSharing && status === Component.Ready)
								rightPanel.visible = false;
						}
					}
				}
								...
								Component {
									...
									PopupButton {
										popup.contentItem: IconLabelButton {
											...
											onClicked: {
												UtilsCpp.copyToClipboard(mainWindow.conference ? mainWindow.conference.core.uri :
						...
						Component {
							...
							AddParticipantsForm {
								...
								onSelectedParticipantsCountChanged: {
									rightPanel.headerSubtitleText = qsTr("group_call_participant_selected", '', selectedParticipantsCount).arg(
								...
								Connections {
									...
									function onCurrentItemChanged() {
										if (participantsStack.currentItem == addParticipantLayout) {
											...
											rightPanel.headerSubtitleText = qsTr("group_call_participant_selected", '',
																				 addParticipantLayout.selectedParticipants.length).arg(
														addParticipantLayout.selectedParticipants.length);
										} else {
				...
				Loader {
					...
					sourceComponent: Item {
						CallLayout {
							...
							anchors.rightMargin: rightPanel.visible ? 0 : Utils.getSizeWithScreenRatio(
																		  10) // Grid and AS have 10 in right margin (so apply -10 here)
							anchors.topMargin: Utils.getSizeWithScreenRatio(10)
							call: mainWindow.call
			...
			RowLayout {
				...
				function refreshLayout() {
					if (mainWindow.callState === LinphoneEnums.CallState.Connected || mainWindow.callState
							=== LinphoneEnums.CallState.StreamsRunning || mainWindow.callState === LinphoneEnums.CallState.Paused
				...
				BigButton {
					...
					KeyNavigation.tab: mainWindow.startingCall ? (videoCameraButton.visible && videoCameraButton.enabled
																  ? videoCameraButton : audioMicrophoneButton) : openStatisticPanelButton
					KeyNavigation.backtab: mainWindow.startingCall ? rightPanel.visible ? Utils.getLastFocusableItemInItem(rightPanel) :
																						  nextItemInFocusChain(false) : callListButton
					onClicked: {
						mainWindow.callTerminatedByUser = true;
				...
				RowLayout {
					...
					CheckableButton {
						...
						checked: mainWindow.call && mainWindow.callState == LinphoneEnums.CallState.Paused || mainWindow.callState
								 == LinphoneEnums.CallState.Pausing || (!mainWindow.conference && mainWindow.callState
																		== LinphoneEnums.CallState.PausedByRemote)
				...
				RowLayout {
					...
					CheckableButton {
						...
						enabled: mainWindow.conferenceInfo || (mainWindow.callState === LinphoneEnums.CallState.Connected || mainWindow.callState
															   === LinphoneEnums.CallState.StreamsRunning)
					...
					CheckableButton {
						...
						Accessible.name: mainWindow.call && mainWindow.call.core.microphoneMuted ? qsTr("call_activate_microphone") : qsTr(
						...
						KeyNavigation.backtab: videoCameraButton.visible && videoCameraButton.enabled ? videoCameraButton :
					...
					PopupButton {
						...
						popup.contentItem: ColumnLayout {
							...
							IconLabelButton {
								...
								contentImageColor: mainWindow.call && mainWindow.call.core.recording ? DefaultStyle.danger_500_main :
								...
								textColor: mainWindow.call && mainWindow.call.core.recording ? DefaultStyle.danger_500_main :
																							   DefaultStyle.main2_500_main
							...
							IconLabelButton {
								...
								contentImageColor: mainWindow.call && mainWindow.call.core.speakerMuted ? DefaultStyle.danger_500_main :
																										  DefaultStyle.main2_500_main
								hoveredImageColor: contentImageColor
								...
								textColor: mainWindow.call && mainWindow.call.core.speakerMuted ? DefaultStyle.danger_500_main :
																								  DefaultStyle.main2_500_main
								hoveredTextColor: textColor
								onCheckedChanged: {
									if (mainWindow.call)
